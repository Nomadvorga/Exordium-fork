...
public class PlayerListComponent
    ...
    @Getter
    private static final Identifier id = NMSHelper.getResourceLocation("minecraft", "player_list");
    ...
    public List<Integer> fastGetPlayerInfoListHashCode(PlayerListContext context, List<PlayerInfo> playerInfos) {
        ...
        for (PlayerInfo playerInfo : playerInfos) {
            ...
            int playerHash = playerInfo.getProfile().id().hashCode();
            playerHash += playerInfo.getProfile().name().hashCode();
            ...
            //#if MC >= 12002
            playerHash += playerInfo.getSkin().body().texturePath().hashCode();
            //#else
