...
public class BufferManager {
    ...
    private final Map<Identifier, BufferInstance<?>> buffers = new HashMap<>();
    ...
    public <T> BufferInstance<T> getBufferInstance(Identifier id, Class<T> context) {
        return (BufferInstance<T>) buffers.get(id);
    }

    public BufferInstance<?> registerBuffer(Identifier id, BufferComponent<?> component,
